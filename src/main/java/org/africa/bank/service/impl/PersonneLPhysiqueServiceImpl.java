...
public class PersonneLPhysiqueServiceImpl implements PersonneLPhysiqueService {
    ...
    private final PersonneLPhysiqueRepository personneRepository;
    private final ModelMapper modelMapper;

    public PersonneLPhysiqueServiceImpl(PersonneLPhysiqueRepository personneRepository,
    ...
    public PersonneLPhysiqueDTO updatePersonne(Long id, PersonneLPhysiqueDTO personneDTO) {
        PersonneLPhysique existing = personneRepository.findById(id)
    ...
    public void deletePersonne(Long id) {
        if (!personneRepository.existsById(id)) {
            throw new ResourceNotFoundException("Personne physique", id);
        }
